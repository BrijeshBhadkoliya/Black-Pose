$(document).on('click', '#pos_order_invoices', function() {
    var id = this.value;
            ...
            var invoiceContent = `
                 <hr>
                                            <div class="row d-flex justify-content-around">
                                                <div class="col-4">
                                                    <p><span class="font-weight-bold">Order Id:</span> ${res.data.orderId}</p>
                                                </div>
                                                <div class="col-4">
                                                    <p>${res.data.createdAt.split('T')[0]}</p>
                                                </div>
                                            </div>
                                            <hr>
                                            ...
                                            <div class="row justify-content-end">
                                                <table class="col-6 table table-borderless text-right">
                                                    <tbody>
                                                        <tr>
                                                            <td>Item Price :</td>
                                                            <td class="text-left">${placement_left} ${res.data.SubTotal - res.data.Productdiscount} ${placement_right}</td>
                                                        </tr>
                                                        <tr>
                                                            <td>Tax:</td>
                                                            <td class="text-left">${placement_left} ${res.data.Tax} ${placement_right}</td>
                                                        </tr>
                                                        <tr>
                                                            <td>Coupon :</td>
                                                            <td class="text-left">${placement_left} ${res.data.Coupondiscount} ${placement_right}</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="font-weight-bold font-18">Total :</td>
                                                            <td class="text-left">${placement_left} ${res.data.Amount} ${placement_right}</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                            <hr>
                                            <div class="row">
                                                <p class="m-l-15">Paid By : ${res.data.paymentMethod.type}</p>
                                            </div>
                                            <hr>
                                            <center>
